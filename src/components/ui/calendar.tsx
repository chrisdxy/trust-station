  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:ring-2 has-focus:ring-ring border border-input shadow-xs rounded-md",
